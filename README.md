...
**Puppetromium** is a [single file](https://github.com/i5ik/puppetromium/blob/main/src/index.js) simple web-browser based on Puppeteer. If Chromium and Puppeteer had a love child, it would be this horrible. Probably. 
